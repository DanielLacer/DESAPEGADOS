...
if(isset($_GET['id_servico'])){
  ...
  $dadosAnuncio = carregarAnuncioServico($conn, $_GET['id_servico'], true);
...
<html lang="PT-BR">
  <head>
    ...
    <link rel="stylesheet" href="../assets/styles/exibirAnuncioServico.css">
                ...
                <div id="carouselExample" class="carousel slide">
                  <div class="carousel-inner">
                    <div class="carousel-item active d-flex justify-content-center align-items-center">
                      <img src="../assets/imagens_padrao/addImage.jpg" height="430px" width="380px">
                    </div>
                  </div>
          ...
          <div class="containerDireita col-8 d-flex flex-column h-100 justify-content-between align-items-center ps-3 pe-3 p-4">
            <div class="row col-12">
              <div class="tituloAnuncio d-flex justify-content-center align-items-center col-12">
                <input type="text" class="form-control text-center disabledBackground" id="iNomeAnuncioServico" name="nNomeAnuncioServico" value="<?php echo $dadosAnuncio['nome_servico'] ?>" disabled>
              </div>
            </div>
            <div class="row col-12">
              <div class="categoriasServico d-flex flex-column justify-content-center align-items-center col-4">
                <label for="iCategoriaServico" >Categoria</label>
                <select type="text" class="form-control text-center disabledBackground" id="iCategoriaServico" name="nCategoriaServico" disabled>
                </select>
              </div>
              <div class="duracao d-flex flex-column justify-content-center align-items-center col-4">
                <label for="duracao">Duração:</label>
                <input type="text" class="form-control text-center disabledBackground" id="iduracao" name="nduracao" value="<?php echo $dadosAnuncio['duracao_servico'].' horas' ?>" disabled>
              </div>
              <div class="localidade d-flex flex-column justify-content-center align-items-center col-4" >
                ...
                <input type="text" class="form-control text-center disabledBackground" id="ilocalidade" name="nlocalidade" value="<?php echo $dadosAnuncio["estado_usuario"] ?> - <?php echo $dadosAnuncio["cidade_usuario"] ?>" disabled>
              </div>
            </div>
            <div class="row col-12">
            ...
            <div class="row col-12">
              <div class="descricao form-floating nome d-flex flex-column justify-content-center align-items-center col-12">
                <textarea class="form-control textarea disabledBackground" name="nDescricaoAnuncioServico" id="iDescricaoAnuncioServico" disabled><?php echo $dadosAnuncio['descri_servico'] ?></textarea>
              </div>
            </div>
            <div class="row col-12">
              <div class="form-floating d-flex justify-content-center align-items-center col-12">
                <input type="text" class="d-none" value="<?php echo $_GET['id_servico'] ?>" name="nIdAnuncioServico">
  ...
  jQuery(document).ready(function() {
    ...
    function retornaImagensAnuncio() {
      ...
      let id_servico = urlParams.get('id_servico');

      $.ajax({

        method: "GET",
        url: "../config/consultasGerais.php",
        data: { action: 'retornaImagensAnuncio', idAnuncio: id_servico, tipoAnuncio: 2 },
        success: function(response) {
            ...
            for(let i = 0; i < arrayImagens.length; i++){
                ...
                imagensPreview += `<img class="mx-auto d-block rounded" src="../assets/imagensAnunciosServicos/${arrayImagens[i]}" height="365px" width="350px">`;
                imagensPreview += `</div>`;
    ...
    function resgatarCategoriasServico() {
      ...
      $.ajax({
        method: "GET",
        url: "../config/consultasGerais.php",
        data: { action: 'resgatarCategoriasServicos', id_servico: id_servico },
        success: function(response) {
