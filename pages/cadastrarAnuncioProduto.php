  ...
  <body>
        ...
        <form id="formCadastroAnuncio" class="d-flex col-12">
          <div class="containerEsquerda col-4 h-100 d-flex flex-column justify-content-between align-items-center ps-3 pe-3 p-4">
              <div class="tituloAnuncio col-12">
                  <h5 class="m-0 text-center">CADASTRO ANÚNCIO DO PRODUTO</h5>
              </div>
          ...
          <div class="containerDireita col-8 d-flex flex-column h-100 justify-content-between align-items-center ps-3 pe-3 p-4">
            <div class="row col-12">
              <div class="tituloAnuncio d-flex justify-content-center align-items-center col-12">
                <input type="text" class="form-control text-center" id="iNomeAnuncioProduto" name="nNomeAnuncioProduto" placeholder="Titulo do Anúncio...">
              </div>
            </div>
            <div class="row col-12 d-flex justify-content-between">
              <div class="categoria d-flex flex-column justify-content-center align-items-center col-4">
                <label for="iCategoriaProduto" >Categoria:</label>
              ...
              <div class="postagem d-flex flex-column justify-content-center align-items-center col-4">
                <label for="iQuantidadeProduto">Quantidade:</label>
                <input type="text" class="form-control text-center" id="iQuantidadeProduto" name="nQuantidadeProduto">
              </div>
              <div class="postagem d-flex flex-column justify-content-center align-items-center col-4">
                <label for="iDataPostagemAnuncio">Data de Postagem:</label>
                <input type="text" class="form-control text-center bg-transparent" id="iDataPostagemAnuncio" name="nDataPostagemAnuncio" disabled>
              </div>
            </div>
            <div class="row col-12">
              <div class="form-floating d-flex flex-column justify-content-center align-items-center col-12">
                <textarea class="form-control textarea" name="nDescricaoAnuncioProduto" id="iDescricaoAnuncioProduto">Digite a descrição anuncio...</textarea>
              </div>
            </div>
            <div class="row col-12">
              <div class="form-floating d-flex justify-content-center align-items-center col-12">
                <button class="btn  col-12 rounded-0 cadastrarAnuncio" type="submit" ><p class="fs-9 m-0 text-white">CADASTRAR ANÚNCIO</p></button>
              </div>
            </div>
          </div>
        </form>
    ...
    <div class="toast position-fixed bottom-0 end-0 m-2" id="cadastroToast" role="alert" aria-live="assertive" aria-atomic="true" ata-animation="true" data-autohide="true" data-delay="3000" >
      ...
      <div class="toast-body">
        Por favor, preencha os campos: Titulo do Anúncio, Categoria, Quantidade e Descrição do Anúncio para cadastrar um novo Anúncio!
      </div>
    </div>
  ...
  jQuery(document).ready(function() {
    ...
    $("#formCadastroAnuncio").on('submit', function(e) {
        ...
        if(nomeAnuncioProduto != "" && nomeAnuncioProduto != null && categoriaAnuncioProduto != "" && categoriaAnuncioProduto != null 
          ...
          $.ajax({
            method: "POST",
            url: "../config/cadastroAnuncioProduto.php",
            data: formData,
            processData: false,
            contentType: false, // 
    ...
    function retornaDataHoje() {
      ...
      document.getElementById('iDataPostagemAnuncio').value = dataFormatada;
